...
pub fn decide_clangd_file(
    ...
    if existing_contents
        .as_deref()
        .is_some_and(|contents| !is_generated_clangd_config(contents))
    {
...
fn is_generated_clangd_config(contents: &str) -> bool {
...
mod tests {
    ...
    #[test]
    fn refreshes_existing_generated_config() {
        let decision = decide_clangd_file(
            r"C:\repo",
            Some("# Auto-generated by Zed C++ Toolkit.\nCompileFlags: {}".to_string()),
            &input(),
        );
        ...
        match decision {
            ...
            ClangdFileDecision::PreserveExisting { .. } => {
                panic!("expected generated config to be refreshed")
            }
        }
    }
}
